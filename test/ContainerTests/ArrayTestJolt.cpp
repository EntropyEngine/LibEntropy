...
// Modified version of https://github.com/jrouwe/JoltPhysics/blob/f73a3c8c3510400da3994aa39949dacea2780bd9/UnitTests/Core/ArrayTest.cpp
// - Added noexcepts to move and copy constructors (to fix incorrect behaviour)
// - Removed std::vector preprocessor guards (as LibEntropy::Array has parity with std::vector for these tests specifically)
TEST_SUITE( "ArrayTest/ModifiedJoltSuite" )
{
